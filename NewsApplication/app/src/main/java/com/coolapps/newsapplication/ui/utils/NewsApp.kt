...
import com.coolapps.newsapplication.ui.components.AppNavRail
    ...
    NewsApplicationTheme {
        ProvideWindowInsets {
            ...
            val navigationActions = remember(navController) {
                NewsapplicationNavigationActions(navController)
            }
            ...
            val currentRoute =
                navBackStackEntry?.destination?.route ?: NewsApplicationDestination.Home_Route
